...
class TicketFilter(filter.FilterSet):
    class Meta:
        ...
        fields = {
            ...
            'classificacao_atendente': lookup_types_ticket['classificacao_atendente'],
            'classificacao_atendente__uuid': lookup_types_classificacao['uuid'],
            'classificacao_atendente__codigo': lookup_types_classificacao['codigo'],
            'classificacao_atendente__nome': lookup_types_classificacao['nome'],
            'classificacao_atendente__descricao': lookup_types_classificacao['descricao'],
...
class MovimentoTicketFilter(filter.FilterSet):
    class Meta:
        ...
        fields = {
            'uuid': lookup_types_movimento_ticket['uuid'],
            'ticket': lookup_types_movimento_ticket['ticket'],
            'ticket__uuid': lookup_types_ticket['uuid'],
            'ticket__codigo': lookup_types_ticket['codigo'],
            'ticket__status': lookup_types_ticket['status'],
            'ticket__solicitante': lookup_types_ticket['solicitante'],
            ...
            'ticket__data_cadastro': lookup_types_ticket['data_cadastro'],
            'ticket__hora_cadastro': lookup_types_ticket['hora_cadastro'],
            'data_inicio': lookup_types_movimento_ticket['data_inicio'],
            'hora_inicio': lookup_types_movimento_ticket['hora_inicio'],
            'data_fim': lookup_types_movimento_ticket['data_fim'],
            'hora_fim': lookup_types_movimento_ticket['hora_fim'],
            'classificacao_atendente': lookup_types_ticket['classificacao_atendente'],
            'classificacao_atendente__uuid': lookup_types_classificacao['uuid'],
            'classificacao_atendente__codigo': lookup_types_classificacao['codigo'],
            'classificacao_atendente__nome': lookup_types_classificacao['nome'],
            'classificacao_atendente__descricao': lookup_types_classificacao['descricao'],
            'atendente': lookup_types_movimento_ticket['atendente'],
            'atendente__uuid': lookup_types_usuario['uuid'],
            'atendente__username': lookup_types_usuario['username'],
            'atendente__first_name': lookup_types_usuario['first_name'],
            'atendente__last_name': lookup_types_usuario['last_name'],
            ...
            'atendente__is_active': lookup_types_usuario['is_active'],
            'atendente__groups': lookup_types_usuario['groups'],
            'solucionado': lookup_types_movimento_ticket['solucionado'],
            'solucionado__uuid': lookup_types_mensagem_ticket['uuid'],
            'solucionado__usuario': lookup_types_mensagem_ticket['usuario'],
            'solucionado__usuario__uuid': lookup_types_usuario['uuid'],
            'solucionado__usuario__username': lookup_types_usuario['username'],
            ...
            'finalizado__is_active': lookup_types_usuario['is_active'],
            'finalizado__groups': lookup_types_usuario['groups'],
            'cancelado': lookup_types_movimento_ticket['cancelado'],
            'cancelado__uuid': lookup_types_usuario['uuid'],
            'cancelado__username': lookup_types_usuario['username'],
            'cancelado__first_name': lookup_types_usuario['first_name'],
            'cancelado__last_name': lookup_types_usuario['last_name'],
